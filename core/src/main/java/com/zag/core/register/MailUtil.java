 ...
 * @Description: 邮箱注册
 * @Author: skyhuihui
 * @CreateDate: 2018/8/8 15:37
 * @UpdateUser: Neil.Zhou
 * @UpdateDate: 2018/8/8 15:37
...
public class MailUtil {
    ...
    //参数 收件人邮箱
    public static void sendActiveMail(String receiveMailAccount, int code) throws Exception {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, int code) throws Exception {
        ...
        message.setContent("尊敬的用户，您好！，您的注册码是" + code, "text/html;charset=UTF-8");
