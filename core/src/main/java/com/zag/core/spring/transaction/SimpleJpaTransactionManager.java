 ...
 * @see
 */
public class SimpleJpaTransactionManager extends JpaTransactionManager {

    private static final long serialVersionUID = -1121090336318974597L;

    private static Logger logger = LoggerFactory.getLogger(SimpleJpaTransactionManager.class);

    private static EventPublisher eventPublisher;

    public void setEventPublisher(EventPublisher eventPublisher) {
        SimpleJpaTransactionManager.eventPublisher = eventPublisher;
    }
    ...
    public SimpleJpaTransactionManager() {
        super();
    }
